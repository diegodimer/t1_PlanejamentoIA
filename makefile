all:
	g++ -std=c++11 blackbox.cpp blackbox.h bfs_graph.cpp iterative_deepening.cpp iterative_deepening.h greedy_bfs.cpp greedy_bfs.h bfs_graph.h astar.cpp astar.h idastar.cpp idastar.h main.cpp -o main
